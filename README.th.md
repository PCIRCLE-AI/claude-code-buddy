...
<p align="center">
  ...
  <p align="center">
    <strong>หน่วยความจำเชิงเอเจนต์สำหรับเอเจนต์คิดโค้ด</strong><br />
...
เอเจนต์คิดโค้ดของคุณไม่ได้แค่ลืมข้อเท็จจริงระหว่างเซสชัน — มันยัง**ทำงานซ้ำ**ด้วย มันเสนอแนวทางที่คุณปฏิเสธไปเมื่อเดือนที่แล้วอีกครั้ง สะดุดกับการทดสอบที่ล้มเหลวตัวเดิม ค้นพบข้อจำกัดที่เคยทำให้ production พังเมื่อเดือนมีนาคมอีกครั้ง และขอให้คุณอธิบายสถาปัตยกรรมที่มันเองมีส่วนร่วมออกแบบซ้ำอีกรอบ

นี่ไม่ใช่ปัญหาของประวัติแชท แต่เป็นปัญหาของหน่วยความจำเอเจนต์ สิ่งที่ต้องอยู่รอดข้ามเซสชันคือ*ตัวงาน*เอง: การตัดสินใจพร้อมเหตุผล ความล้มเหลวพร้อมวิธีแก้ และความเชื่อมโยงระหว่างกัน

**MeMesh คือหน่วยความจำนั้น** hook จะบันทึกจากสิ่งที่เอเจนต์ทำจริง (เซสชัน คอมมิต ความล้มเหลว — ไม่ใช่โน้ตที่จดเอง) การเรียกคืนจะแทรกให้ในจังหวะที่เอเจนต์ลงมือทำ (ตอนเริ่มเซสชัน ก่อนแก้ไขไฟล์) และชั้นกราฟความรู้จะคงความถูกต้องเมื่อเวลาผ่านไป (supersession, การตรวจจับความขัดแย้งที่ตัดสินโดย LLM) ติดตั้งด้วย npm หน่วยความจำอยู่ในไฟล์ `~/.memesh/knowledge-graph.db` เชื่อมต่อกับ Claude Code หรือไคลเอนต์ที่รองรับ MCP ตัวใดก็ได้
...
## เบนช์มาร์ก — 95.60% R@5 on LongMemEval-S
