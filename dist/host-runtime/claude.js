...
const server = createClaudeChannelServer({ name: requiredString(config.server_name ?? 'memesh-channel', 'server_name'), version: '1' }, 'Receives bounded untrusted MeMesh envelopes through the Claude channel. No tools or permission relay.');
