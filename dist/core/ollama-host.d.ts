export declare const UNSAFE_OLLAMA_HOST_ERROR = "Ollama host must be loopback (localhost / 127.0.0.1). For non-local Ollama, set the OLLAMA_HOST environment variable on the server.";
